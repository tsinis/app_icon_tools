            ...
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    AutoSizeText(
                        context.watch<UploadFile>().isProperFile
                    ...
                    if (showIconReq) ...[
                      ...
                      Material(
                        ...
                        child: DataTable(
                          ...
                          rows: <DataRow>[
                            DataRow(
                              onSelectChanged: (_) async => await context.read<UploadFile>().openGuidelinesURL(),
                              cells: <DataCell>[
                            ...
                            DataRow(
                                onSelectChanged: (_) async => await context
                                    .read<UploadFile>()
                                    .openGuidelinesURL(fromGoogle: true, locale: S.of(context).locale),
                                cells: <DataCell>[
