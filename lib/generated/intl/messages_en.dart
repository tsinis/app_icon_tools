...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "isTransparent" : MessageLookupByLibrary.simpleMessage("ℹ️  The image have Alpha Channel (transparency). "),
    ...
    "noBackground" : MessageLookupByLibrary.simpleMessage("Please select background/foreground first."),
    ...
    "transparencyAdaptive" : MessageLookupByLibrary.simpleMessage("ℹ️  The Foreground have no Alpha Channel (transparency). In this case, the background image will not be visible at all."),
