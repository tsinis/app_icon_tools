...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "isTransparent" : MessageLookupByLibrary.simpleMessage("The image has an Alpha Channel (transparency)."),
    "issuesToClipboard" : MessageLookupByLibrary.simpleMessage("Long press to save all issues to the clipboard."),
    ...
    "officialDocs" : MessageLookupByLibrary.simpleMessage("Click once for more information from the official documentation."),
    ...
    "transparencyAdaptive" : MessageLookupByLibrary.simpleMessage("*The Foreground has no Alpha Channel (transparency). In this case, the background image will not be visible at all."),
